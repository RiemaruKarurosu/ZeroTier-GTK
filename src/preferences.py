...
class PreferencesSettings:
    ...
    def __init__(self, zerotier_window, application):
        ...
        self.create_action_rows(group, "Zerotier start", "The app needs this to work", self.on_switch_state_start,
                                zerotier_window.on_check_lib(), True)
        self.create_action_rows(group, "Zerotier start on boot",
